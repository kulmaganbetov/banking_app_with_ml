    ...
    <div className="min-h-screen bg-gray-950 flex items-center justify-center px-4">
      ...
      >
        <div className="text-center mb-8">
          <div className="w-12 h-12 rounded-xl bg-gradient-to-br from-primary to-accent flex items-center justify-center text-white font-bold text-xl mx-auto mb-4">
            S
          </div>
          <h2 className="text-2xl font-bold">Welcome Back</h2>
          <p className="text-sm text-gray-400 mt-1">Sign in to SecureBank</p>
        </div>
        ...
        <p className="text-center text-xs text-gray-500 mt-6">
          Demo: <span className="text-gray-400">demo / demo123</span>
        </p>
      </motion.div>
    </div>
  );
